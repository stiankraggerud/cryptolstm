...
#new_data['RSI'] = compute_RSI(new_data['Close'],180)
...
#scaler_rsi = joblib.load('scaler_rsi.pkl') 
...
# Count the number of each category in the predictions
predicted_counts = new_data['Prediction'].value_counts()
print(predicted_counts)

# Count the number of each category in the actual signals
actual_counts = new_data['Signal'].value_counts()
print(actual_counts)
