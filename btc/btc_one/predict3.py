...
if(os.path.exists('raw_predictions.pkl')):
    raw_predictions = joblib.load('raw_predictions.pkl')
else:
    raw_predictions = model.predict(x_new)
    joblib.dump(raw_predictions, 'raw_predictions.pkl') # save the raw predictions
