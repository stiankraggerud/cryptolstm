...
stock_data.loc[(future_return > 0.007) | (future_return < -0.007), 'Signal'] = 'Trade'
...
#y_train = encoder.fit_transform(train_data['Signal'])
y_train = keras.utils.to_categorical(y_train)
print(y_train.shape[1])  # etter encoding, dette bør nå være 2
...
model.add(layers.Dense(2, activation='softmax'))  # Vi har nå 2 klasser: 'Hold', 'Trade'
model.summary()
