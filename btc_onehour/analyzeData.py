...
def analyze_stock_data(model_path, data_path, numberOfBars=100, min_prominence=150):

    # Load the saved model
    loaded_model = keras.models.load_model(model_path, custom_objects={'cost_sensitive_loss': cost_sensitive_loss})

    # Load the data
    stock_data = stockDataHandler.LoadData(data_path)
...
# Example Usage:
# analyze_stock_data('onehour_2018_2023_rmsprop_rolling_epoch60.h5', 'onehour2018_2023.csv')
