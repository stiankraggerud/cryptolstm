...
for index, row in test_data.iterrows():      
    ...
    current_input_values = row[['Close_normalized','Open_normalized', 'High_normalized','Low_normalized', 'Number_of_trades_normalized', 'Volume_normalized', 'EMA50_normalized', 'EMA100_normalized', 'MACD_normalized']].values.astype(np.float32)      
    current_input = np.reshape(current_input_values, (1, 1, 9))      
...
plot_filename = "predict_v1_1.html"  
