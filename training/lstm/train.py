...
X = stock_data[['Close_normalized','Number_of_trades_normalized', 'Volume_normalized', 'EMA50_normalized', 'EMA100_normalized', 'MACD_normalized']]
y = stock_data['Target']
...
model.add(layers.LSTM(200, return_sequences=True, input_shape=(X_train.shape[1], 6))) 
