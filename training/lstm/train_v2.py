...
save_every_n_epochs = 100  # Endre dette tallet etter ønske  
...
filename_format = os.path.join(models_directory, 'lstm_model_2018-06_2023_train_v2_epoch-{epoch:03d}.h5')  
...
model.fit(X_train, y_train, epochs=1000, batch_size=8, callbacks=[checkpoint])  
