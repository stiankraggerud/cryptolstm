...
models_directory = 'saved_models_train_v3'  
if not os.path.exists(models_directory):  
    os.makedirs(models_directory)  
  
# Definer filnavnformatet for å reflektere antall epoker modellen er trent på  
filename_format = os.path.join(models_directory, 'lstm_model_2017-06_2023_train_v3-1_epoch-{epoch:03d}_400_400_50_1.h5')  
